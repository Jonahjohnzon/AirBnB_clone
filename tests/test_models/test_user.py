...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_two_users_different_created_at(self):
        ...
        sleep(0.05)
        us2a = User()
        self.assertLess(us1a.created_at, us2a.created_at)
    ...
    def test_args_unused(self):
        usa = User(None)
        self.assertNotIn(None, usa.__dict__.values())

    def test_instantiation_with_kwargs(self):
        dt = datetime.today()
        dt_iso = dt.isoformat()
        usa = User(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(usa.id, "345")
        self.assertEqual(usa.created_at, dt)
        self.assertEqual(usa.updated_at, dt)
...
class TestUser_to_dict(unittest.TestCase):
    ...
    def test_to_dict_output(self):
        ...
        usa = User()
        usa.id = "123456"
        usa.created_at = usa.updated_at = dt
        tdict = {
            'id': '123456',
            '__class__': 'User',
        ...
        self.assertDictEqual(usa.to_dict(), tdict)

    def test_contrast_to_dict_dunder_dict(self):
        usa = User()
        self.assertNotEqual(usa.to_dict(), usa.__dict__)
