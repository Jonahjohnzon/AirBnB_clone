...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        p = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("help quit"))
            self.assertEqual(p, f.getvalue().strip())

    def test_help_create(self):
        p = ("Usage: create <class>\n        "
             "Create a new class instance and print its id.")
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("help create"))
            self.assertEqual(p, f.getvalue().strip())

    def test_help_EOF(self):
        p = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("help EOF"))
            self.assertEqual(p, f.getvalue().strip())

    def test_help_show(self):
        p = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
             "Display the string representation of a class instance of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("help show"))
            self.assertEqual(p, f.getvalue().strip())

    def test_help_destroy(self):
        p = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
             "Delete a class instance of a given id.")
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("help destroy"))
            self.assertEqual(p, f.getvalue().strip())

    def test_help_all(self):
        p = ("Usage: all or all <class> or <class>.all()\n        "
    ...
    def test_help_count(self):
        p = ("Usage: count <class> or <class>.count()\n        "
    ...
    def test_help(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("help"))
            self.assertEqual(p, f.getvalue().strip())
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def test_create_object(self):
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("create BaseModel"))
            self.assertLess(0, len(f.getvalue().strip()))
            testKey = "BaseModel.{}".format(f.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("create User"))
            self.assertLess(0, len(f.getvalue().strip()))
            testKey = "User.{}".format(f.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("create State"))
            self.assertLess(0, len(f.getvalue().strip()))
            testKey = "State.{}".format(f.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("create City"))
            self.assertLess(0, len(f.getvalue().strip()))
            testKey = "City.{}".format(f.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("create Amenity"))
            self.assertLess(0, len(f.getvalue().strip()))
            testKey = "Amenity.{}".format(f.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("create Place"))
            self.assertLess(0, len(f.getvalue().strip()))
            testKey = "Place.{}".format(f.getvalue().strip())
            self.assertIn(testKey, storage.all().keys())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("create Review"))
            self.assertLess(0, len(f.getvalue().strip()))
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_invalid_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("show MyModel"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            self.assertFalse(cmd.onecmd("MyModel.show()"))
            self.assertEqual(rectify, f.getvalue().strip())

    def test_show_missing_id_space_notation(self):
        rectify = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("show BaseModel"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("show User"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("show State"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("show City"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("show Amenity"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
    ...
    def test_show_missing_id_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("BaseModel.show()"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("User.show()"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("State.show()"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("City.show()"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("Amenity.show()"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("Place.show()"))
            self.assertEqual(rectify, f.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as f:
            cmd = HBNBCommand()
            self.assertFalse(cmd.onecmd("Review.show()"))
            self.assertEqual(rectify, f.getvalue().strip())
